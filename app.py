...
class threadClass:
    ...
    def run(self):
        ...
        collection_name = self.scrapper_object.getReviewsToDisplay(expected_review=self.expected_review,
                                                                   searchString=self.searchString, username='scrapper',
                                                                   password='scrapper',
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            scrapper_object = FlipkratScrapper(executable_path=ChromeDriverManager().install(),
                                               chrome_options=chrome_options)#by this we have installed chromedriver which helps to access chrome browser
            mongoClient = MongoDBManagement(username='scrapper', password='scrapper')
